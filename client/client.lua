...
local maxPlayers, players, nameServer, position
...
function renderRadar()
	--if getElementData(localPlayer, "showHud") ~= "on" then return end
	if (maskTexture) and (getElementInterior(localPlayer) == 0) then
		...
		--dxDrawImage(radar.x, radar.y, 493*px, (radar.height), texture.text)
			--dxCreateText (nameServer, radar.x + radar.width + 92*px, radar.y + 131*py, 300*px, 20*py, tocolor(255, 255, 255), 1, font, "left", "center")
			--dxCreateText (players.."/"..maxPlayers, radar.x + radar.width + 92*px, radar.y + 176*py, 300*px, 20*py, tocolor(255, 255, 255), 1, font, "left", "center")
			--dxCreateText (position:upper(), radar.x + radar.width + 3*px, radar.y + 223*py, 300*px, 20*py, tocolor(255, 255, 255), 1, font, "left", "center")
